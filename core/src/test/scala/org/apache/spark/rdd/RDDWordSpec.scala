...
class RDDWordSpec extends SparkWordSpec with SharedSparkContext {
  "An RDD" when {
    "the number of partitions is specified" should {
      ...
      "have the correct element count" in {
    ...
    "created with duplicate elements" should {
      "eliminate those duplicates when distinct is called" in {
