...
class RDDFlatSpec extends SparkFlatSpec with SharedSparkContext {
  "An RDD" should "have the specified number of partitions" in {
  ...
  it should "have the correct element count, no matter how many partitions it has" in {
  ...
  "An RDD with duplicate elements" should "eliminate duplicates with distinct" in {
