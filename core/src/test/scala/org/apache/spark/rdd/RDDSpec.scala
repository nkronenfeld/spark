...
class RDDSpec extends SparkFunSpec with SharedSparkContext {
  describe("RDD") {
    it("should create rdds with the specified number of partitions") {
    ...
    it("should have the correct element count") {
    ...
    it("should count distinct elements properly") {
